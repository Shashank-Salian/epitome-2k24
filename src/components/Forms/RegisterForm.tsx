...
const RegisterForm = () => {
  ...
  return (
    <div
      ...
      className="relative flex_center flex-col gap-2 2xl:gap-4 font-oxanium w-fit p-4 py-10 sm:p-8 rounded-lg top-52 md:top-44 mb-6 bg-background/40 backdrop-blur-lg lg:ml-[4em]"
    >
