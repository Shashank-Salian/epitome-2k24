...
const Payment = () => {
    ...
    return (
        <div className="relative w-full h-full mt-40 mb-12 mx4 p-8 rounded-lg bg-foreground text-background z-10 backdrop-blur">
                ...
                <div className="flex flex-col w-full h-full px-6">
                    ...
                    <div className="font-oxanium">
                        ...
                        <h2 className="flex mb-4">
                            ...
                            <div
                                className="mx-2 flex"
                                onClick={() => window.navigator.clipboard.writeText(BANK_NAME)}
                            >
